...
btnGuardarComentario.addProperty('xpath', ConditionType.EQUALS, '//form[contains(@class,\'form-elementcomment-create\')]//button[contains(@class,\'btn-submit-form\')]')
...
alertaOperacionExitosa.addProperty('xpath', ConditionType.EQUALS, '//div[contains(@class,\'alert-success\') and contains(normalize-space(),\'Operación exitosa\')]')
...
filaPlantilla.addProperty('xpath', ConditionType.EQUALS, '//tr[.//td[normalize-space()=\'Plantilla QA\']]')
...
lapizPlantilla.addProperty('xpath', ConditionType.EQUALS, '//tr[.//td[normalize-space()=\'Plantilla QA\']]//a[contains(@class,\'emailTemplate-edit\')]')
...
modalConfirmar.addProperty('xpath', ConditionType.EQUALS, '//div[contains(@class,\'modal-content\') and .//h3[contains(text(),\'Confirmar eliminación\')]]')
...
btnEliminarConfirmado.addProperty('xpath', ConditionType.EQUALS, '//button[contains(@class,\'btn-danger\') and normalize-space()=\'Eliminar\']')
...
alertaEliminadoFinal.addProperty('xpath', ConditionType.EQUALS, '//div[contains(@class,\'alert-success\') and contains(normalize-space(),\'Template eliminado con éxito\')]')
...
btnCerrarGrowlFinal.addProperty('xpath', ConditionType.EQUALS, '//div[contains(@class,\'alert-success\')]//button[contains(@class,\'btn-close\')]')
